...
const goGithub = () => {
	window.open('https://github.com/brockai', '_blank'); // Replace with your desired URL
};
	...
	return (
		<HeaderRight>
			<div className='row g-3'>
				...
				{/*	Github */}
				<div className='col-auto'>
					<Popovers trigger='hover' desc='Github - brockai'>
						<Button
							// eslint-disable-next-line react/jsx-props-no-spreading
							{...styledBtn}
							icon='CustomGithub'
							onClick={goGithub}
							aria-label='Github - brockai'
						/>
					</Popovers>
				</div>
				...
				{/*	Login auth0 */}
				<div className='col-auto'>
					<Popovers trigger='hover' desc='Aiuthenticate'>
						<Button
							// eslint-disable-next-line react/jsx-props-no-spreading
							{...styledBtn}
							icon='Login'
